  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        scrolled ? 'bg-white/80 backdrop-blur-xl shadow-lg' : 'bg-white/60 backdrop-blur-md'
      }`}>
          ...
          <div className="flex justify-between items-center h-16 md:h-16">
            ...
            <div className="hidden md:flex items-center space-x-1">
              {navLinks.map((link, index) => (
                ...
                >
                  {link.name}
                  <span className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-linear-to-r from-gray-900 to-gray-700 transition-all duration-300 group-hover:w-3/4 ${
        ...
        {/* Mobile Menu */}
        <div className={`md:hidden absolute top-0 left-0 w-full h-screen bg-white/95 backdrop-blur-xl transition-all duration-300 ${
          ...
          <div className="flex flex-col items-center justify-center h-full space-y-8 px-6">
            {navLinks.map((link, index) => (
              ...
              >
                ...
                <span className={`absolute -bottom-1 left-0 w-0 h-0.5 bg-linear-to-r from-gray-900 to-gray-700 transition-all duration-300 group-hover:w-full ${
