...
export default function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-slate-950 text-black dark:text-white border-t border-gray-200 dark:border-white/5 mt-20 transition-colors duration-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div className="space-y-6">
            <h3 className="text-lg font-semibold relative inline-block">
              Explore
              <span className="absolute bottom-0 left-0 w-12 h-0.5 bg-linear-to-r from-gray-800 to-transparent dark:from-white/20 dark:to-transparent"></span>
            </h3>
              ...
              {exploreLinks.map((link, index) => (
                <li key={index}>
                  <a
                    ...
                    className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-all duration-300 inline-flex items-center group"
                  >
                    <span
            ...
            <div className="text-center md:text-left">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4">
                {socialLinks.map((social, index) => (
                  ...
                  >
                    <div
                      className={`w-11 h-11 bg-gray-100 dark:bg-slate-900 rounded-xl flex items-center justify-center transition-all duration-300 ${
                        hoveredSocial === index
                          ? "bg-gray-800 dark:bg-blue-600 scale-110 rotate-6"
                    ...
                    <span
                      className={`absolute -bottom-8 left-1/2 transform -translate-x-1/2 text-xs text-gray-600 dark:text-gray-400 whitespace-nowrap transition-opacity duration-300 ${
